function startclassification(){
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/oANUqfrlT/model.json',modelReady);
}
function modelReady(){
...
function gotResults (error, results){
    ...
    console.error(error);
        ...
        random_number_g = Math.floor(Math.random() * 100) + 1;
